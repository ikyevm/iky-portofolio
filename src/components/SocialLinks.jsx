...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/ikyevm/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@Rifkie.ar",
    icon: Instagram,
    url: "https://www.instagram.com/ikyevm/?hl=id",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@iky evm",
    icon: Youtube,
    url: "https://www.youtube.com/@ikyevm",
    color: "#FF0000",
